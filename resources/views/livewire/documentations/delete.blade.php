<div>
    ...
    <flux:modal name="delete-documentation-{{ $documentation->id }}" class="md:w-[500px] bg-white dark:bg-zinc-900 rounded-lg shadow-xl" wire:listener="close-modal">
        <div class="p-6 space-y-6">
            ...
            <div class="flex justify-end space-x-3">
                <flux:button type="button" variant="danger" wire:click="deleteDocumentation" wire:loading.attr="disabled">
