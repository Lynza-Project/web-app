<div>
    <form wire:submit.prevent="createDocumentation" class="space-y-6">
        <div>
        ...
        <div>
            <label for="image" class="block text-sm font-medium text-gray-700 mb-1">Image de couverture (optionnelle)</label>
