...
use App\Models\User;
use App\Policies\LostAndFoundPolicy;
use Illuminate\Foundation\Testing\RefreshDatabase;
use Tests\TestCase;

class LostAndFoundPolicyTest extends TestCase
{
    use RefreshDatabase;

    private LostAndFoundPolicy $policy;
    ...
    protected function setUp(): void
    {
        ...
        $this->policy = new LostAndFoundPolicy();
        ...
        $this->lostAndFound = LostAndFound::factory()->create([
            'organization_id' => $this->organization1->id,
        ]);
    }
    ...
    {
        $this->assertTrue($this->policy->view($this->user, $this->lostAndFound));
    }
    ...
    public function test_view_returns_false_for_user_in_different_organization()
    {
        ...
        $this->assertFalse($this->policy->view($userFromOtherOrg, $this->lostAndFound));
    }
    ...
    {
        $this->assertTrue($this->policy->update($this->superAdmin, $this->lostAndFound));
    }

    public function test_update_returns_true_for_admin_in_same_organization()
    {
        $this->assertTrue($this->policy->update($this->admin, $this->lostAndFound));
    }
    ...
    public function test_update_returns_false_for_admin_in_different_organization()
    {
        ...
        $this->assertFalse($this->policy->update($adminFromOtherOrg, $this->lostAndFound));
    }

    public function test_update_returns_false_for_regular_user()
    {
        $this->assertFalse($this->policy->update($this->user, $this->lostAndFound));
    }

    public function test_delete_returns_true_for_super_admin()
    {
        $this->assertTrue($this->policy->delete($this->superAdmin, $this->lostAndFound));
    }

    public function test_delete_returns_true_for_admin_in_same_organization()
    {
        $this->assertTrue($this->policy->delete($this->admin, $this->lostAndFound));
    }
    ...
    public function test_delete_returns_false_for_admin_in_different_organization()
    {
        ...
        $this->assertFalse($this->policy->delete($adminFromOtherOrg, $this->lostAndFound));
    }

    public function test_delete_returns_false_for_regular_user()
    {
        $this->assertFalse($this->policy->delete($this->user, $this->lostAndFound));
    }
    ...
    {
        $this->assertTrue($this->policy->forceDelete($this->superAdmin, $this->lostAndFound));
    }

    public function test_force_delete_returns_false_for_admin_and_regular_user()
    {
        $this->assertFalse($this->policy->forceDelete($this->admin, $this->lostAndFound));
        $this->assertFalse($this->policy->forceDelete($this->user, $this->lostAndFound));
    }
}
