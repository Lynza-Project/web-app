...
class TicketMessagePolicyTest extends TestCase
{
    ...
    private TicketMessagePolicy $policy;
    ...
    private TicketMessage $otherUserMessage;

    protected function setUp(): void
    {
        parent::setUp();

        $this->policy = new TicketMessagePolicy();
        ...
        $this->ticketMessage = TicketMessage::factory()->create([
            'ticket_id' => $this->ticket->id,
            'user_id' => $this->user->id,
            'organization_id' => $this->organization1->id,
        ]);

        $this->otherUserMessage = TicketMessage::factory()->create([
            'ticket_id' => $this->ticket->id,
    ...
    {
        $this->assertTrue($this->policy->view($this->user, $this->ticketMessage));
    }
    ...
    public function test_view_returns_false_for_user_in_different_organization()
    {
        ...
        $this->assertFalse($this->policy->view($userFromOtherOrg, $this->ticketMessage));
    }
    ...
    {
        $this->assertTrue($this->policy->update($this->superAdmin, $this->ticketMessage));
    }

    public function test_update_returns_true_for_admin_in_same_organization()
    {
        $this->assertTrue($this->policy->update($this->admin, $this->ticketMessage));
    }

    public function test_update_returns_true_for_message_owner()
    {
        $this->assertTrue($this->policy->update($this->user, $this->ticketMessage));
    }

    public function test_update_returns_false_for_other_users()
    {
        $this->assertFalse($this->policy->update($this->otherUser, $this->ticketMessage));
    }
    ...
    public function test_update_returns_false_for_admin_in_different_organization()
    {
        ...
        $this->assertFalse($this->policy->update($adminFromOtherOrg, $this->ticketMessage));
    }

    public function test_delete_returns_true_for_super_admin()
    {
        $this->assertTrue($this->policy->delete($this->superAdmin, $this->ticketMessage));
    }

    public function test_delete_returns_true_for_admin_in_same_organization()
    {
        $this->assertTrue($this->policy->delete($this->admin, $this->ticketMessage));
    }

    public function test_delete_returns_true_for_message_owner()
    {
        $this->assertTrue($this->policy->delete($this->user, $this->ticketMessage));
    }

    public function test_delete_returns_false_for_other_users()
    {
        $this->assertFalse($this->policy->delete($this->otherUser, $this->ticketMessage));
    }
    ...
    public function test_delete_returns_false_for_admin_in_different_organization()
    {
        ...
        $this->assertFalse($this->policy->delete($adminFromOtherOrg, $this->ticketMessage));
    }
