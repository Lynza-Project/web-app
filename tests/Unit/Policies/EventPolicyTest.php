...
class EventPolicyTest extends TestCase
{
    ...
    {
        $this->assertTrue($this->policy->view($this->user, $this->event));
    }
    ...
    public function test_view_returns_false_for_user_in_different_organization()
    {
        ...
        $this->assertFalse($this->policy->view($userFromOtherOrg, $this->event));
    }
    ...
    {
        $this->assertTrue($this->policy->update($this->superAdmin, $this->event));
    }

    public function test_update_returns_true_for_admin_in_same_organization()
    {
        $this->assertTrue($this->policy->update($this->admin, $this->event));
    }
    ...
    public function test_update_returns_false_for_admin_in_different_organization()
    {
        ...
        $this->assertFalse($this->policy->update($adminFromOtherOrg, $this->event));
    }

    public function test_update_returns_false_for_regular_user()
    {
        $this->assertFalse($this->policy->update($this->user, $this->event));
    }

    public function test_delete_returns_true_for_super_admin()
    {
        $this->assertTrue($this->policy->delete($this->superAdmin, $this->event));
    }

    public function test_delete_returns_true_for_admin_in_same_organization()
    {
        $this->assertTrue($this->policy->delete($this->admin, $this->event));
    }
    ...
    public function test_delete_returns_false_for_admin_in_different_organization()
    {
        ...
        $this->assertFalse($this->policy->delete($adminFromOtherOrg, $this->event));
    }

    public function test_delete_returns_false_for_regular_user()
    {
        $this->assertFalse($this->policy->delete($this->user, $this->event));
    }
